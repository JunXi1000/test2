        ...
        <el-form ref="searchFromComponents" :model="searchForm" inline>
          ...
          <el-form-item label="状态" prop="status">
            <el-select v-model="searchForm.status" placeholder="请选择" clearable filterable style="width: 150px">
              <el-option :label="item" :key="item" :value="item" v-for="item in statuList"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
      ...
      <el-card>
        ...
        <div style="margin-top: 20px">
          <el-pagination
              ...
              :courrent-page="pageInfo.pageNum"
      ...
      <el-form ref="formRef" :model="formData" label-width="100">
        ...
        >
          <el-radio-group v-model="formData.status">
            <el-radio v-for="item in statuList" :key="item" :value="item">{{item}}</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
      <template #footer>
...
import {Delete, Refresh, Search, Plus, Edit, Check, Close, RefreshLeft} from '@element-plus/icons-vue';
